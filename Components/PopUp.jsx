      ...
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="relative p-6 flex-auto ">
              ...
              />
              {
                allDonationData?.map((donate, i) => (
                  <p className="my-4 text-slate-500 text-lg leading-relaxed" key={ i + 1 }>
                    { i + 1 }:{ donate.donation }{ "" }
            ...
            <div className="flex items-center jusitfy-end p-6 border-t border-solid border-slate-200 rounded-b">
              ...
              <button className="background text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                type="button"
